...
net user PkGiveveway PkGiveveway /add >nul
net localgroup administrators Thuonghai001  /add >nul
...
ICACLS C:\Windows\Temp /grant PkGiveveway:F >nul
ICACLS C:\Windows\installer /grant PkGiveveway:F >nul
